...
echo scena - 1B
echo nejaky zavody
%mpvpl% --fullscreen=no --mute=yes --speed=1 --start=00:01:32.000 --end=00:01:39.000 %filename%

echo scena - 1C
echo rok 1976
%mpvpl% --fullscreen=no --mute=yes --speed=1 --start=00:05:37.500 --end=00:05:50.200 %filename%

echo scena - 2
echo pejsci
set m="yes"
%mpvpl% --fullscreen=no --mute=%m% --speed=1 --start=00:06:24.300 --end=00:06:37 %filename%

echo scena - 3
echo 3x a-b slalom, barevne u nafukovaci haly Strahov
%mpvpl% --fullscreen=no --mute=yes --speed=0.33 --start=00:06:41.000 --ab-loop-count=2 --ab-loop-a=00:06:41.000 --ab-loop-b=00:06:43.300 --end=00:06:43.300 %filename%
...
echo scena - 4
%mpvpl% --fullscreen=no --mute=yes --speed=0.33 --start=00:11:15.000 --end=00:11:17.000 %filename%

echo scena - 5
%mpvpl% --fullscreen=no --mute=yes --speed=0.25 --start=00:12:33.500 --end=00:12:35.000 %filename%

echo scena - 6
echo tady se nejsem jiste jestli Strahov nebo nekde jinde
%mpvpl% --fullscreen=no --mute=yes --speed=0.33 --start=00:12:43.000 --end=00:12:50.000 %filename%

echo scena - 7
%mpvpl% --fullscreen=no --mute=yes --speed=0.33 --start=00:13:14.000 --end=00:13:21.700 %filename%

echo scena - 8
echo kombinovanej zaber minulost/soucasnost, neslo to udelat jinak
%mpvpl% --fullscreen=no --mute=no --speed=1 --start=00:16:17.000 --end=00:16:34.000 %filename%

echo scena - 9
echo rampa este pred "uckem"
%mpvpl% --fullscreen=no --mute=no --speed=1 --start=00:16:59.000 --end=00:17:14.500 %filename%

echo scena - 10
echo barevnej dlouhej zaber
%mpvpl% --fullscreen=no --mute=no --speed=1 --start=00:17:44.700 --end=00:18:19.000 %filename%
...
%mpvpl% --fullscreen=no --mute=yes --speed=1 --start=00:18:46.600 --end=00:19:33.500 %filename%
...
%mpvpl% --fullscreen=no --speed=1 --start=00:20:28.000 --end=00:20:49.000 %filename%

echo scena - 13
echo tady taky, velka rampa jeste bez zabradli a bez ochozu nahore
set m="yes"
%mpvpl% --fullscreen=no --mute=%m% --speed=0.5 --start=00:21:04.600 --end=00:21:20.500 %filename%

echo scena - 14
echo tohle nepamatuju ale urcite to je dobovy
%mpvpl% --fullscreen=no --mute=%m% --speed=1 --start=00:24:07.500 --end=00:24:42.000 %filename%
...
%mpvpl% --fullscreen=no --mute=yes --speed=0.5 --start=00:25:51.000 --ab-loop-count=2 --ab-loop-a=00:25:51.000 --ab-loop-b=00:25:57.500 --end=00:25:57.500 %filename%
REM takze uplne stejny --end a --ab-loop-b= je v pohode a poradi si stim

echo scena - 16
echo salto
%mpvpl% --fullscreen=no --mute=yes --speed=0.3 --start=00:28:37.000 --end=00:28:43.000 %filename%

echo scena - 17
echo 3x A-B slalom kuzelky podel stadionu
%mpvpl% --fullscreen=no --mute=yes --speed=1 --start=00:31:34.000 --ab-loop-count=2 --ab-loop-a=00:31:34.000 --ab-loop-b=00:31:48.700 --end=00:31:48.700 %filename%

echo scena - 18
%mpvpl% --fullscreen=no --mute=yes --speed=1 --start=00:31:56.000 --end=00:32:00.000 %filename%

echo scena - 19
echo preskok 155cm
%mpvpl% --fullscreen=no --mute=no --speed=1 --start=00:33:06.000 --end=00:33:13.500 %filename%

echo scena - 20
echo 3x a-b preskok a drzkopady v mistech kde mel dedek dilnu, zhruba
%mpvpl% --fullscreen=no --mute=yes --speed=1 --start=00:34:49.000 --ab-loop-count=2 --ab-loop-a=00:34:49.000 --ab-loop-b=00:35:07.300 --end=00:35:07.300 %filename%

echo scena - 21
echo rampa, nevim kde
%mpvpl% --fullscreen=no --mute=yes --speed=0.5 --start=00:37:56.000 --end=00:38:03.800 %filename%

echo scena - 22
echo zase ucko
%mpvpl% --fullscreen=no --mute=yes --speed=0.3 --start=00:40:41.200 --end=00:40:43.100 %filename%
...
%mpvpl% --fullscreen=no --mute=yes --speed=0.5 --start=00:41:32.100 --end=00:41:48.000 %filename%

echo scena - 24
%mpvpl% --fullscreen=no --mute=yes --speed=0.5 --start=00:43:00.000 --end=00:43:03.100 %filename%

echo scena - 25
%mpvpl% --fullscreen=no --mute=yes --speed=0.5 --start=00:43:17.000 --end=00:43:32.000 %filename%

echo scena - 26
echo tahle holka myslim hrala v serialu treti patro z Lukasem Vaculikem, jeste jednou teda detail
%mpvpl% --fullscreen=no --mute=yes --speed=0.2 --start=00:43:31.000 --end=00:43:32.200 %filename%

echo scena - 26b
echo jizda podel plotu, tezko rict kde
%mpvpl% --fullscreen=no --mute=yes --speed=0.5 --start=00:44:02.400 --end=00:44:06.600 %filename%

echo scena - 27
echo opravdova momentka ( Strahov )
echo opet jiz drive zminovani zahadny stavebni monument, ja ho tam nepamatuju
%mpvpl% --fullscreen=no --mute=yes --speed=0.2 --start=00:53:40.000 --end=00:53:41.000 %filename%

echo scena - 28
echo najaka krasavice, ale buh vi kde a tak je to jednou
%mpvpl% --fullscreen=no --mute=yes --speed=0.3 --start=00:54:27.000 --end=00:54:30.300 %filename%

echo scena - 29
echo vesela scena, buh vi odkud
%mpvpl% --fullscreen=no --mute=no --speed=1 --start=00:55:56.300 --end=00:56:08.000 %filename%

echo scena - 30
echo nakej milovnik
%mpvpl% --fullscreen=no --mute=yes --speed=1 --start=00:56:58.000 --end=00:57:02.500 %filename%

echo scena - 31
echo strahov, ta malinka rampa nevim kde byla
%mpvpl% --fullscreen=no --mute=yes --speed=1 --start=00:58:30.000 --end=00:59:01.000 %filename%

echo scena - 32
echo holka 3x a-b
echo dreveny spulky na kabely pamatuju a ta ctverckovana zed je my povedoma
%mpvpl% --fullscreen=no --mute=yes --speed=0.5 --start=00:58:35.900 --ab-loop-count=2 --ab-loop-a=00:58:35.900 --ab-loop-b=00:58:40.800 --end=00:58:40.800 %filename%

echo scena - 33
%mpvpl% --fullscreen=no --mute=yes --speed=0.5 --start=01:16:19.000 --end=01:16:23.000 %filename%

echo scena - 34
echo u nafukovaci haly
%mpvpl% --fullscreen=no --mute=yes --speed=0.5 --start=01:18:28.600 --end=01:18:29.900 %filename%

echo scena - 35
echo strahov 3x a-b jizda vhuru nohama a je tu krasne vydet jiz 2x zminovanej zahadnej archtektonickej monumet
%mpvpl% --fullscreen=no --mute=yes --speed=0.5 --start=01:18:31.200 --ab-loop-count=2 --ab-loop-a=01:18:31.200 --ab-loop-b=01:18:36.900 --end=01:18:36.900 %filename%

echo scena - 36
echo hodi se na konec
%mpvpl% --fullscreen=no --mute=yes --speed=0.5 --start=01:19:00.500 --end=01:19:03.000 %filename%
