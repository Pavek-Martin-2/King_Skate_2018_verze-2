...
$out_array += "play_all_mute.exe" # stimto nazvem to bude zkompilovany a pak v davce zavola toto a vlastne se akualizuje
...
$out_array += "set /a p=1"
#$out_array += ":start" # udela batce label :start
...
$out_file_name = "_play_all_mute.bat"
