...
REM  ^ pridano 12.4.2025 doba zobrazovani napisu %osdm% v OSD
...
echo scena - 35
echo strahov 3x a-b jizda vhuru nohama a je tu krasne vydet jiz 2x zminovanej zahadnej archtektonickej monument
