...
Write-Host -ForegroundColor Yellow "videa budou BEZ zvuku a bude 200 % puvodni rychlost"
...
$out_array += "play_all_mute_200_procent_speed.exe" # stimto nazvem to bude zkompilovany a pak v davce zavola toto a vlastne se akualizuje
...
$out_file_name = "_play_all_mute_200.bat"
